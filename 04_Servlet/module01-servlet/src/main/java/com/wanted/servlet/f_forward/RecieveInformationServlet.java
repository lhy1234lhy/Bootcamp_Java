...
@WebServlet("/forward")
public class RecieveInformationServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        *   해당 서블릿은 사용자의 요청이 들어오면 비즈니스 로직을
        *   처리하는 용도의 책임만 갖게 만들고자 한다.
        ...
        *   forward 받은 서블릿의 존재를 클라이언트가 알 필요가 없기 떄문에
        *   url 자체는 변경되지 않는다.
        ...
        *   Insert 등의 DML 구문은 forward 방식으로 처리하면 큰일난다.
        *  */
