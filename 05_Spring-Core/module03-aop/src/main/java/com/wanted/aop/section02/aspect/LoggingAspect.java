...
public class LoggingAspect {
    ...
    *   - (String, ..) : 첫 번째 String 이여야 하먀, 나머지는 상관 없음.
    *  */
    ...
    public void logBefore(JoinPoint joinPoint){
        ...
        Object[] args = joinPoint.getArgs(); // 메서드에 손 올리면 메서드 반환형 볼 수 있다.
    ...
    *  */
    @AfterReturning(
            ...
            returning = "result" // 이름은 내맘. 암거나 다 가능
    )
    ...
    *   사용 예시 : 예외 관련 로그,
    *   - 예외 복구 로직 등에 사용된다. - > 할 수 있긴 하지만, 더 좋은 예외처리로 하는 것이 좋다.
    *  */
    @AfterThrowing(
            pointcut = "execution(* com.wanted.aop.section02.MemberService.*(..))",
            throwing = "exception"
