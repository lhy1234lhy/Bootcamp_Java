...
public class Application {
    public static void main(String[] args) {
        ...
        *   값들을 인자로 전달해야하기 떄문에 한 눈에 안 들어온다.
        *   3. 리턴구문은 항상 1개의 값만 가능하기 떄문에 회원 정보를 묶어서 return 할 수 없다.
        *  */

        /* hi. 위 단점들을 극복하기 위해 사용자 정의의 자료형이 나왔다.
        *   Member 클래스 만들기
        * */

        /* hi. 사용자 정의의 자료형 사용해보기
        *   1. 클래스명 변수명 = new 클래스명();
        *   지금까지 이렇게 작성한 구문은 객체를 생성하는 구문이다.
        *   2. 사용자 정의의 자료형인 클래스를 생성하면,
        *   클래스에 우리가 정의한 필드(전역변수), 메서드 대로 객체가 생성된다.
        * */
