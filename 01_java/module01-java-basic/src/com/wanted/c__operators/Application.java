package com.wanted.c__operators;
...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("둘 다 참인가? : " + (isFalse && isTrue)); // AND는 false를 먼저 넣는게 효율적
        System.out.println("둘 중 하나가 거짓인가? : " + (isTrue || isFalse)); //OR는 true를 먼저 넣는게 효율적
        ...
        System.out.println("age = " + (age++)); // 후위연산자 (실행되고 나서 ++해줌)
