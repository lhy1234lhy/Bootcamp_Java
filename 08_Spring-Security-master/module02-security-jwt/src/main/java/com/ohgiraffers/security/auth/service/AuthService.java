...
public class AuthService {
    ...
    public TokenResponseDTO login(LoginRequestDto loginRequestDto) {
        ...
        // authentication 여기에 사용자 정보가 들어있다.
    ...
    // @Valid는 클라이언트(프론트엔드)가 보낸 데이터(JSON 등)를 컨트롤러에서 받을 때,
    // 데이터의 '유효성 검사(Validation)'를 자동으로 수행하기 위해 사용
    public UserResponseDto register(@Valid SignupRequestDto request) {
        ...
        // builder 메서드 혹은 팩토리 메서드를 활용하는 것이 추천되는 구조이다.
