...
# 해당 모델을 HuggingFace에 있는 영어 문장 긍정/부정 분류 AI 모델이다.
...
# sentence 사용자 입력 문장 / prediction : 문장에 대한 AI 응답 값
...
def analyze_single_sentence(analyzer : Any) -> None : 
    ...
    # 문장이 하나여도 Pipeline 은 결과를 List로 반환하기 때문에 [0] 으로 한다.
...
def main() -> None :
    ...
    try:
        # create_sentiment_analyzer() 함수는 Pipeline을 Return 한다.
